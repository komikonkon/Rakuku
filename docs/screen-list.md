...
| **S07** | 復習セッション | 画面 | タイピング想起で1問ずつ回答 | 意味提示、英語入力欄、ヒント、答えを見る、送信 | S06 → S08 | §5.5, §5.9 |
| **S08** | 復習結果 | 画面 | セッション結果の表示 | 正答数、ステータス内訳、もう一度／終了 | S07 → S06/S02 | §5.5, §5.9 |
...
| S07 復習セッション | 出題中 / 正誤フィードバック / ヒント表示 / 答え表示 |
| S08 復習結果 | 通常 |
